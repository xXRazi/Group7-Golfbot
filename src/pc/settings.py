...
DELIVERY_POSITION_TOLERANCE = _env_float("GOLFBOT_DELIVERY_POSITION_TOLERANCE", 17.0)
DELIVERY_REQUIRE_CENTER_POSITION = _env_bool("GOLFBOT_DELIVERY_REQUIRE_CENTER_POSITION", False)
DELIVERY_CLAW_POSITION_TOLERANCE = _env_float("GOLFBOT_DELIVERY_CLAW_POSITION_TOLERANCE", 30.0)
DELIVERY_HEADING_TOLERANCE = 3.0
DELIVERY_GOAL_A_HEADING_TOLERANCE = _env_float("GOLFBOT_DELIVERY_GOAL_A_HEADING_TOLERANCE", 11.0)
