...
RED_CROSS_WAYPOINT_ACCEPTANCE_RADIUS = _env_float(
    "GOLFBOT_RED_CROSS_WAYPOINT_ACCEPTANCE_RADIUS",
    28.0,
)
PICKUP_RED_CROSS_LOOKAHEAD_DISTANCE = _env_float(
    "GOLFBOT_PICKUP_RED_CROSS_LOOKAHEAD_DISTANCE",
    85.0,
)
DELIVERY_RED_CROSS_LOOKAHEAD_DISTANCE = _env_float(
    "GOLFBOT_DELIVERY_RED_CROSS_LOOKAHEAD_DISTANCE",
    135.0,
)
...
MISSING_GRAPPLER_REVERSE_ENABLED = _env_bool("GOLFBOT_MISSING_GRAPPLER_REVERSE", True)
MISSING_GRAPPLER_REVERSE_SPEED = _env_int("GOLFBOT_MISSING_GRAPPLER_REVERSE_SPEED", -18)
MISSING_GRAPPLER_REVERSE_SECONDS = _env_float("GOLFBOT_MISSING_GRAPPLER_REVERSE_SECONDS", 0.25)
MISSING_GRAPPLER_REVERSE_SETTLE_SECONDS = _env_float(
...
GRAPPLER_FORWARD_OFFSET_FALLBACK = 30.0
...
PICKUP_FINAL_SCOOP_DISTANCE = 5.0
PICKUP_GRAPPLER_CLOSE_DISTANCE = 26.0
...
DELIVERY_CLAW_EDGE_MARGIN = _env_int("GOLFBOT_DELIVERY_CLAW_EDGE_MARGIN", 50.0)
DELIVERY_PREAPPROACH_EXTRA_DISTANCE = 45.0
DELIVERY_POSITION_TOLERANCE = _env_float("GOLFBOT_DELIVERY_POSITION_TOLERANCE", 20.0)
DELIVERY_REQUIRE_CENTER_POSITION = _env_bool("GOLFBOT_DELIVERY_REQUIRE_CENTER_POSITION", False)
DELIVERY_CLAW_POSITION_TOLERANCE = _env_float("GOLFBOT_DELIVERY_CLAW_POSITION_TOLERANCE", 35.0)
DELIVERY_HEADING_TOLERANCE = 11.0
DELIVERY_GOAL_A_HEADING_TOLERANCE = _env_float("GOLFBOT_DELIVERY_GOAL_A_HEADING_TOLERANCE", 3.0)
DELIVERY_GOAL_B_HEADING_TOLERANCE = _env_float(
    "GOLFBOT_DELIVERY_GOAL_B_HEADING_TOLERANCE",
...
DELIVERY_RED_CROSS_CLEARANCE_MARGIN = _env_int("GOLFBOT_DELIVERY_RED_CROSS_CLEARANCE_MARGIN", 50)
DELIVERY_RED_CROSS_RETRY_FRAMES = _env_int(
    "GOLFBOT_DELIVERY_RED_CROSS_RETRY_FRAMES",
    ROBOT_POSE_RETRY_FRAMES,
)
DELIVERY_DYNAMIC_REPLAN_MAX_STEPS = _env_int("GOLFBOT_DELIVERY_DYNAMIC_REPLAN_MAX_STEPS", 10)
DELIVERY_MIN_CENTER_GOAL_DISTANCE = _env_float("GOLFBOT_DELIVERY_MIN_CENTER_GOAL_DISTANCE", 130.0)
DELIVERY_MIN_CLAW_GOAL_DISTANCE = _env_float("GOLFBOT_DELIVERY_MIN_CLAW_GOAL_DISTANCE", 85.0)
DELIVERY_GOAL_DISTANCE_CORRECTION_MARGIN = _env_float(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_CORRECTION_MARGIN",
    8.0,
)
DELIVERY_GOAL_DISTANCE_CORRECTION_ATTEMPTS = _env_int(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_CORRECTION_ATTEMPTS",
    3,
)
DELIVERY_GOAL_DISTANCE_REVERSE_ENABLED = _env_bool("GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE", True)
DELIVERY_GOAL_DISTANCE_REVERSE_SPEED = _env_int("GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE_SPEED", -18)
DELIVERY_GOAL_DISTANCE_REVERSE_SECONDS_PER_MAP_UNIT = _env_float(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE_SECONDS_PER_MAP_UNIT",
    0.014,
)
DELIVERY_GOAL_DISTANCE_REVERSE_MIN_SECONDS = _env_float(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE_MIN_SECONDS",
    0.08,
)
DELIVERY_GOAL_DISTANCE_REVERSE_MAX_SECONDS = _env_float(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE_MAX_SECONDS",
    0.55,
)
DELIVERY_GOAL_DISTANCE_REVERSE_MAX_DISTANCE = _env_float(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE_MAX_DISTANCE",
    70.0,
)
DELIVERY_GOAL_DISTANCE_REVERSE_HEADING_TOLERANCE = _env_float(
    "GOLFBOT_DELIVERY_GOAL_DISTANCE_REVERSE_HEADING_TOLERANCE",
    25.0,
)
